...
import com.zr.service1.ZwcxService;

import net.sf.json.JSONArray;

public class ZwcxController extends HttpServlet{
	
	 ZwcxService zwcxService=new ZwcxService();
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		List<Zw>  zw=(List<Zw>) zwcxService.yhcx(zwmc);
		JSONArray data=JSONArray.fromObject(zw);
